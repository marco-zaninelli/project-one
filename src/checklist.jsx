...
const Checklist = ({initialChecklist}) => {
    // State to store checklist
    const [checklist, setChecklist] = useState(initialChecklist);

    // State to track current item
    const [hoveredIndex, setHoveredIndex] = useState(null);

    // State to track edited item
    ...
    return (
        <div className="h-screen min-h-[400px] w-screen min-w-[400px] flex items-center">
            <div className="flex flex-col w-[400px] h-[400px] mx-auto border border-black rounded-lg">
                    ...
                    {checklist.map((item, index) => (
                        ...
                        >
                            ...
                            {isEditing === index ? (
                                ...
                                <span
                                    className={`flex-grow text-base px-2 py-0.5 my-0 cursor-pointer ${item.completed ? 'line-through' : ''} ${hoveredIndex !== index ? 'pr-5' : ''}`}
